 ...
 */
public class GoodsListViewPiFaAdapter extends BaseAdapter {
    ...
    public GoodsListViewPiFaAdapter(Context context, String listType) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final GoodsList bean = goodsLists.get(position);
        ...
        if (null == convertView) {
            ...
            holder.textGoodsPiFaNum = (TextView) convertView.findViewById(R.id.tvGoodsPiFa);
            holder.textGoodsPrice = (TextView) convertView.findViewById(R.id.textGoodsPrice);
            holder.textGoodsPrice1 = (TextView) convertView.findViewById(R.id.textGoodsPrice1);
...
//        holder.textGoodsPrice1.setVisibility(View.VISIBLE);
...
//        imageLoader.displayImage(bean.getGoods_image_url(), holder.imageGoodsPic, options, animateFirstListener);
        ...
        if (bean.getGoods_jingle().equals("null")) {
            holder.textGoodsJingle.setVisibility(View.GONE);
        } else {
            holder.textGoodsJingle.setText(bean.getGoods_jingle());
        }
        holder.textGoodsPiFaNum.setVisibility(View.VISIBLE);
        String wholesale_num = bean.getWholesale_num();
        String wholesale_price = bean.getWholesale_price();
        holder.textGoodsPiFaNum.setText("起购数" + bean.getWholesale_num());
        holder.textGoodsPrice.setText("￥" + bean.getWholesale_price());
        ...
        holder.llGoodsItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("num", bean.getWholesale_num());
                intent.putExtra("price", bean.getWholesale_price());
                context.startActivity(intent);
            }
        });
