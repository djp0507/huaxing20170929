...
import cn.hx.hn.android.bean.GiftListBean;
import cn.hx.hn.android.bean.GoodsListBean;
import cn.hx.hn.android.bean.ImageFileBean;
import cn.hx.hn.android.bean.OrderExchangeBean;
...
public class OrderExchangeActivity extends BaseActivity {
    ...
    public void loadDatas(){
        String url= myApplication.getpath()+Constants.URL_ORDER_REFUND+ "&key=" + myApplication.getLoginKey() + "&order_id=" + orderId;
    ...
    public void btnCommitExchange(View v){
        String url=myApplication.getpath()+Constants.URL_ORDER_EXCHANGE_REFUND_ALL;
        HashMap<String, String> params = new HashMap<String, String>();
        params.put("key", myApplication.getLoginKey());
