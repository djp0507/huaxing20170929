...
import cn.hx.hn.android.bean.OrderDetailsBean;
import cn.hx.hn.android.bean.OrderGoods;
import cn.hx.hn.android.bean.ZenPinBean;
...
public class OrderDetailsActivity extends BaseActivity {
    ...
    private void loadOrderDetails() {
        String url = myApplication.getpath() + Constants.URL_ORDER_DETAILS + "&key=" + myApplication.getLoginKey() + "&order_id=" + orderId;
                        ...
                        textOrderSure.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                if (textOrderSure.getText().toString().equals("确认收货")) {
                                    loadingSaveOrderData(myApplication.getpath()+Constants.URL_ORDER_RECEIVE, orderDetails.getOrder_id());
                                        ...
                                        .setPositiveButton("确认",
                                                new DialogInterface.OnClickListener() {
                                                    public void onClick(
                                                            ...
                                                            int whichButton) {
                                                        if (s.equals("取消订单")) {
                                                            loadingSaveOrderData(myApplication.getpath() + Constants.URL_ORDER_CANCEL, orderDetails.getOrder_id());
    ...
    public void loadNewWuLiuInfo() {
        String url = myApplication.getpath() + Constants.URL_ORDER_WULIU_NEW_ONE;
