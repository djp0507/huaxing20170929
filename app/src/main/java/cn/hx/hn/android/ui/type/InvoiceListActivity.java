...
import cn.hx.hn.android.adapter.InvoiceAddSpinnerAdapter;
import cn.hx.hn.android.adapter.InvoiceListViewAdapter;
import cn.hx.hn.android.bean.CityList;
import cn.hx.hn.android.bean.InvoiceList;
...
import cn.hx.hn.android.custom.MyAddInvoice;
...
public class InvoiceListActivity extends BaseActivity  {
    ...
    public void loadingInvoiceListData() {
        String url = myApplication.getpath()+Constants.URL_INVOICE_LIST;
    ...
    public void getInvoiceContextData(final Spinner spinner) {
        String url = myApplication.getpath()+Constants.URL_INVOICE_CONTEXT_LIST;
        ;
        HashMap<String, String> params = new HashMap<String, String>();
        params.put("key", myApplication.getLoginKey());
        RemoteDataHandler.asyncLoginPostDataString(url, params, myApplication, new Callback() {
    ...
    public void invoiceDelete(String inv_id) {
        String url = myApplication.getpath()+Constants.URL_INVOICE_DELETE;
        ;
        HashMap<String, String> params = new HashMap<String, String>();
        params.put("key", myApplication.getLoginKey());
    ...
    public void loadingSaveInvoiceData(final MyAddInvoice addInvoiceDialog, String inv_title_select, String inv_title, String inv_content) {
        String url = myApplication.getpath()+Constants.URL_INVOICE_ADD;
        ;
        HashMap<String, String> params = new HashMap<String, String>();
        params.put("key", myApplication.getLoginKey());
