...
public class IMNewListViewAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            ...
            holder.nameID = (TextView) view.findViewById(R.id.nameID);
            holder.msgNumID = (TextView) view.findViewById(R.id.msgNumID);
            holder.imageGoodsPic = (ImageView) view.findViewById(R.id.imageGoodsPic);
            holder.userStateID = (ImageView) view.findViewById(R.id.userStateID);
            view.setTag(holder);
        }else{
