...
import cn.hx.hn.android.bean.WuLiuCompany;
...
public class OrderExchangeSendGoodsActivity extends BaseActivity {
 ...
 private Spinner spinner1;
    ...
    public void loadDatas(){
        String url= myApplication.getpath()+Constants.URL_ORDER_EXCHANGE_GOODS_SEND+"&key="+myApplication.getLoginKey()+"&return_id="+id;
...
public void btnSureSend(String number){
    ...
    String url=myApplication.getpath()+Constants.URL_ORDER_EXCHANGE_GOODS_SAVA;
