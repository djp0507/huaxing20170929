 ...
 * PackageName:cn.shopnc.android.model
 * FileNmae:Login.java
 */
...
public class Mine {
    ...
    public Mine(String offline_show, String memberName, String memberAvatar, String levelName, String favStore, String favGoods, String orderNopay, String orderNoreceipt, String orderNotakes,
                String orderNoeval, String orderReturn, String level, String is_distr, String is_movie, String is_movie_msg, String recommended_code) {
        this.offline_show = offline_show;
    ...
    public static Mine newInstanceList(String json) {
        ...
        try {
            ...
            if (obj.length() > 0) {
                ...
                String recommended_code = obj.optString("recommended_code");
                String offline_show = obj.optString("offline_show");
                bean = new Mine(offline_show, memberName, memberAvatar, levelName, favStore, favGoods, orderNopay, orderNoreceipt, orderNotakes, orderNoeval, orderReturn, level, is_distr, is_movie, is_movie_msg, recommended_code);
            }
    ...
    public void setOffline_show(String offline_show) {
        this.offline_show = offline_show;
    }
