...
import cn.hx.hn.android.bean.VirtualList;
...
import cn.hx.hn.android.ui.mine.VirtualInfoActivity;
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("操作提示")
                        ...
                        .setPositiveButton("确认", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                loadingSaveOrderData(myApplication.getpath()+Constants.URL_MEMBER_VR_ORDER_CANCEL, bean.getOrder_id());
                            }
                        }).create().show();
            }
        });
...
//        });
    ...
    public void loadingWXPaymentData(String pay_sn) {
        ...
        RemoteDataHandler.asyncLoginPostDataString(
                myApplication.getpath()+Constants.URL_MEMBER_WX_VPAYMENT, params, myApplication,
                new Callback() {
                    @Override
