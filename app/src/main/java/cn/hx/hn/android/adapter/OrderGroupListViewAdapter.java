...
import cn.hx.hn.android.bean.OrderGoodsList;
...
import cn.hx.hn.android.custom.ShareButton;
...
import cn.hx.hn.android.ui.mine.OrderDeliverDetailsActivity;
import cn.hx.hn.android.ui.mine.OrderDetailsActivity;
import cn.hx.hn.android.ui.mine.OrderExchangeActivity;
import cn.hx.hn.android.ui.mine.PayMentWebActivity;
import cn.hx.hn.android.ui.type.EvaluateActivity;
import cn.hx.hn.android.ui.type.EvaluateAddActivity;
            ...
            if(orderList.getState_desc().equals("已取消")){
                ...
                textOrderDel.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        loadingSaveOrderData(myApplication.getpath()+Constants.URL_ORDER_DEL, orderList.getOrder_id());
                    }
                });
            }
        } else {
                    ...
                    builder.setTitle("操作提示")
                            ...
                            .setPositiveButton("确认",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int whichButton) {
                                            loadingSaveOrderData(myApplication.getpath()+Constants.URL_ORDER_RECEIVE, orderList.getOrder_id());
                                        }
                                    }).create().show();
                }else if (s.equals("评价")){
                            ...
                            .setPositiveButton("确认",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(
                                                ...
                                                int whichButton) {
                                            if (key.equals("取消订单")) {
                                                loadingSaveOrderData(myApplication.getpath()+Constants.URL_ORDER_CANCEL, orderList.getOrder_id());
                                            }
                                            if(key.equals("退款")){
...
//        });
    ...
    public void loadingPaymentListData() {
        ...
        RemoteDataHandler.asyncLoginPostDataString(
                myApplication.getpath()+Constants.URL_ORDER_PAYMENT_LIST, params, myApplication,
                new Callback() {
                    @Override
...
//                                menuGrid.setAdapter(simperAdapter);
    ...
    public void loadingWXPaymentData(String pay_sn) {
        ...
        RemoteDataHandler.asyncLoginPostDataString(
                myApplication.getpath()+Constants.URL_MEMBER_WX_PAYMENT, params, myApplication,
                new Callback() {
                    @Override
                    public void dataLoaded(ResponseData data) {
                        String json = data.getJson();
