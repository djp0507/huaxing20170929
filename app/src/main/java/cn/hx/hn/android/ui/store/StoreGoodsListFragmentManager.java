...
import cn.hx.hn.android.ui.type.GoodsGridFragment;
import cn.hx.hn.android.ui.type.GoodsListFragment;
...
public class StoreGoodsListFragmentManager extends FragmentActivity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wholesale_user = getIntent().getStringExtra("wholesale_user");
    ...
    public void loadGoods() {
        String url = null;
        if (TextUtils.isEmpty(wholesale_user)) {
            url = Constants.URL_STORE_GOODS_LIST;
        } else if (wholesale_user.equals("1")) {
            url = myApplication.getpath() + Constants.URL_WHOLESALE_LIST; //进入批发列表
    ...
    private void loadGoodsList(String url) {
        ...
        if (!TextUtils.isEmpty(wholesale_user)) {
            goodsListFragment.type = 1;
        } else {
            goodsListFragment.type = 0;
        }
    ...
    private void loadGoodsGrid(String url) {
        ...
        if (!TextUtils.isEmpty(wholesale_user)) {
            goodsGridFragment.types = 1;
        } else {
            goodsGridFragment.types = 0;
        }
