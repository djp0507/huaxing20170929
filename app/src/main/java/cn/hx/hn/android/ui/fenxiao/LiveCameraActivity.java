...
import cn.hx.hn.android.lib.popupwindow.BubbleRelativeLayout;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.zhibo_share:
                ...
                new ShareAction(LiveCameraActivity.this).setDisplayList(SHARE_MEDIA.SINA,SHARE_MEDIA.QQ,SHARE_MEDIA.QZONE,SHARE_MEDIA.WEIXIN,SHARE_MEDIA.WEIXIN_CIRCLE,SHARE_MEDIA.SMS)
                        .withText(text)
                        .withTitle(title)
                        .withTargetUrl(url)
