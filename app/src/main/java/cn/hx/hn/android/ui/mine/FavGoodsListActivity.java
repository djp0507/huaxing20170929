...
import cn.hx.hn.android.adapter.FavoritesGoodsGridViewAdapter;
import cn.hx.hn.android.bean.FavoritesList;
...
import cn.hx.hn.android.ncinterface.INCOnItemDel;
...
public class FavGoodsListActivity extends BaseActivity {
    ...
    public void loadingfavoritesListData() {
        String url = myApplication.getpath()+Constants.URL_FAVORITES_LIST + "&curpage=" + pageno + "&page=" + Constants.PAGESIZE;
    ...
    public void deleteFav(final String fav_id, final int position) {
        ...
        ncDialog.setOnDialogConfirm(new INCOnDialogConfirm() {
            ...
            public void onDialogConfirm() {
                String url = myApplication.getpath()+Constants.URL_DELETE_FAV;
