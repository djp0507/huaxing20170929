...
import cn.hx.hn.android.adapter.AreaSpinnerAdapter;
import cn.hx.hn.android.adapter.ContractGridViewAdapter;
import cn.hx.hn.android.bean.CityList;
import cn.hx.hn.android.bean.ContractInfo;
...
public class GoodsListFragmentManager extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        history_htn = (Button) findViewById(R.id.history_htn);
        //返回按钮
...
//                }
    ...
    public void loadGoods() {
        String url = myApplication.getpath()+Constants.URL_GOODSLIST;
