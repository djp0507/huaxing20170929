...
import cn.hx.hn.android.adapter.SimpleCardAdapter;
            ...
            public void dataLoaded(ResponseData data) {
                if(data.getCode() == 200){
                    ...
                    try {
                        ...
                        final ArrayList<FocusListBean> ListBeen = JsonUtil.getBean(focus_list,new TypeToken<ArrayList<FocusListBean>>(){}.getType());
                        ...
                        ArrayList<NewsListBean> cateList = JsonUtil.getBean(lists,new TypeToken<ArrayList<NewsListBean>>(){}.getType());
                        if(cateList != null) {
                            if (!cateList.isEmpty()) {
