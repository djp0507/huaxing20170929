...
public class OrderExchangeListActivity extends BaseActivity {
    ...
    private void loadMoneyDatas(){
        String url= myApplication.getpath()+Constants.URL_ORDER_EXCHANGE_MONEY_LIST+"&key="+myApplication.getLoginKey();
    ...
    public void loadGoodsDatas(){
        String url= myApplication.getpath()+Constants.URL_ORDER_EXCHANGE_GOODS_LIST+"&key="+myApplication.getLoginKey();
        RemoteDataHandler.asyncDataStringGet(url,new RemoteDataHandler.Callback() {
            @Override
            public void dataLoaded(ResponseData data) {
                String json=data.getJson();
                    ...
                    builder.setTitle("操作提示")
                            ...
                            .setPositiveButton("确认",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int whichButton) {
                                            String url=myApplication.getpath()+Constants.URL_ORDER_EXCHANGE_GOODS_DELAY;
