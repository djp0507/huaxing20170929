...
import cn.hx.hn.android.bean.FocusListBean;
import cn.hx.hn.android.bean.NewsListBean;
...
import cn.hx.hn.android.bean.item.VisibilityItem;
import cn.hx.hn.android.custom.GlideCircleTransform;
import cn.hx.hn.android.custom.MyDecoration;
import cn.hx.hn.android.lib.tab.NetworkImageHolderView;
import cn.hx.hn.android.ui.fenxiao.DianboAudeoInfoActivity;
import cn.hx.hn.android.lib.video.videoimg.VideoFrameImageLoader;
import cn.hx.hn.android.ui.fenxiao.WebActivity;
import cn.hx.hn.android.ui.fenxiao.ZhiBoActivity;
import cn.hx.hn.android.ui.fenxiao.ZhixunContentActivity;
...
//        if(view == null){
            ...
            holder = new ViewHolder();
                ...
                /*图片*/
            holder.iv_image_bg = (ImageView)view.findViewById(R.id.iv_image_bg);
            holder.iv_image_play = (ImageView)view.findViewById(R.id.iv_image_play);
            holder.img1_text = (RelativeLayout)view.findViewById(R.id.img1_text);
              /*视频*/
            holder.video_text = (RelativeLayout)view.findViewById(R.id.video_text);
            holder.jcVideoPlayerStandard = (JCVideoPlayerStandard)view.findViewById(R.id.videoplayer);

//        TextView textView = (TextView)view.findViewById(R.id.textView);
//        TextView img_price = (TextView)view.findViewById(R.id.img_price);
//            holder.textView3 = (TextView)view.findViewById(R.id.textView3);
            holder.dian_title = (TextView) view.findViewById(R.id.dian_title);
            holder.dian_shoucang = (ImageView) view.findViewById(R.id.dian_shoucang);
            holder.dian_logo = (ImageView) view.findViewById(R.id.dian_logo);
            holder.recyclerView_wenzi = (RecyclerView)view.findViewById(R.id.recyclerView);
...
//        }
        ...
        dingboWenziAdapter.setOnItemClickListener(new cn.hx.hn.android.lib.tab.OnItemClickListener() {
            @Override
...
//            holder = new setZiXunListViewHolder();
            news_name = (TextView)view.findViewById(R.id.news_name);
            pageview = (TextView)view.findViewById(R.id.page_view);
...
//        myListView.addHeaderView(header);
    ...
    public View setLiveListView(NewsListBean bean,View view){
        ...
        live_num = (TextView)view.findViewById(R.id.live_num);
        live_logo = (ImageView)view.findViewById(R.id.live_logo);
...
//        LoadImage.loadImg(mContext,live_logo,bean.getMovie_cover_img());//
    ...
    /*跳转到直播详情页面*/
    public class LiveInfoOnclick implements View.OnClickListener{

        private NewsListBean live_id;
        public LiveInfoOnclick(NewsListBean commonid){
            this.live_id = commonid;
        }
        ...
        public void onClick(View v) {
            if (ShopHelper.isLogin(mContext, MyShopApplication.getInstance().getLoginKey())) {
                ...
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra("live_id", live_id.getVideo_id());
                intent.putExtra("live_url", live_id.getMovie_play_url());
                mContext.startActivity(intent);
            }
