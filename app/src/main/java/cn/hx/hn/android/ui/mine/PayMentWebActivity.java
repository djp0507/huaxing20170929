...
public class PayMentWebActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(order_sn!= null && !order_sn.equals("") && !order_sn.equals("null")){
			webviewID.loadUrl(myApplication.getpath()+Constants.URL_VIRTUAL_ORDER_PAYMENT+"&key="+myApplication.getLoginKey()+"&pay_sn="+order_sn);
		}else{
			webviewID.loadUrl(myApplication.getpath()+Constants.URL_ORDER_PAYMENT+"&key="+myApplication.getLoginKey()+"&pay_sn="+pay_sn);
		}
