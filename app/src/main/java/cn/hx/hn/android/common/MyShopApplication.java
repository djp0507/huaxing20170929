...
import cn.hx.hn.android.bean.IMMemberInFo;
...
//    public BDLocationListener myListener = new MyLocationListener();
    ...
    public String getpath(){
        if (SpUtils.getSpBoolean(this,SaveSp.OFFLINE_SHOW)){
            return Constants.PROTOCOL + BuildConfig.HOST_XIANXIA + Constants.APP + "/index.php?";
        }else{
            return Constants.PROTOCOL + BuildConfig.HOST_XIANSHANG + Constants.APP + "/index.php?";
        }
    }
...
//        /***
//         * 初始化定位百度地图sdk，建议在Application中创建
//         */
