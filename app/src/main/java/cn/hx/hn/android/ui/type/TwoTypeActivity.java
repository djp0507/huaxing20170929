...
import cn.hx.hn.android.adapter.TwoTypeExpandableListViewAdapter;
import cn.hx.hn.android.bean.TwoType;
...
public class TwoTypeActivity extends Activity implements OnClickListener{
	...
	public void loadingTypeNextGData(String gc_id){
		...
		String url = ((MyShopApplication)getApplication()).getpath()+Constants.URL_GOODSCLASS+"&gc_id="+gc_id;
