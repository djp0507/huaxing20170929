...
import cn.hx.hn.android.adapter.VirtualOrderListViewAdapter;
...
public class VirtualListActivity extends BaseActivity implements IXListViewListener {
    ...
    public void loadingListData() {
        String url = myApplication.getpath()+Constants.URL_MEMBER_VR_ORDER + "&curpage=" + pageno + "&page=" + Constants.PAGESIZE;
