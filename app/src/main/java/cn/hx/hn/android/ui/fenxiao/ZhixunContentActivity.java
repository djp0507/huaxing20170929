...
import cn.hx.hn.android.adapter.ZhixunContentAdapter;
import cn.hx.hn.android.bean.MobileBody;
import cn.hx.hn.android.bean.goodsCommonList;
...
import cn.hx.hn.android.custom.HtmlTextView;
...
public class ZhixunContentActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Logger.d(url);
        progressDialog = new MyProgressDialog(ZhixunContentActivity.this,"正在加载中...",R.anim.progress_round);
        progressDialog.show();
...
//                Logger.d(data.getJson());
                if(data.getCode() == 200){
                    try {
                        ...
                        ArrayList<goodsCommonList> commonList = JsonUtil.getBean(goods_common_list,new TypeToken<ArrayList<goodsCommonList>>(){}.getType());
...
//                        String page_view   = JsonObj.optString("page_view");
                        ...
                        ArrayList<MobileBody> mobileBodies = JsonUtil.getBean(mobile_body,new TypeToken<ArrayList<MobileBody>>(){}.getType());
                        ...
                        if(!mobileBodies.isEmpty()){
                            for (int i = 0 ;i<mobileBodies.size();i++){
                                ...
                                if(("text").equals(body.getType())){
                                    ...
                                    HtmlTextView htmlTextView = (HtmlTextView)view.findViewById(R.id.new_info);
...
//                                    imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
                                ...
                                if(("video").equals(body.getType())){
                                    ...
                                    final RelativeLayout img1_text = (RelativeLayout)view.findViewById(R.id.img1_text1);
                                    final RelativeLayout img1_avdeo = (RelativeLayout)view.findViewById(R.id.img1_avdeo);
                                    ImageView iv_image_bg = (ImageView)view.findViewById(R.id.iv_image_bg1);
                                    ImageView iv_image_play = (ImageView)view.findViewById(R.id.iv_image_play1);
